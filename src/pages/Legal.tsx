                    ...
                    <div className="p-8 space-y-12">
                        ...
                        <section id="legal">
                            ...
                            <div className="prose prose-blue max-w-none text-gray-600 space-y-4">
                                <p><strong>{t('legal.publisher', 'Éditeur du site :')}</strong> LawJustLaw SAS, société au capital de 50 000 €, dont le siège social est situé au 1275 route de chateau neuf 26320 saint marcelle les valence.</p>
                                <p><strong>{t('legal.director', 'Directeur de la publication :')}</strong> Administrateur LawJustLaw.</p>
                                <p><strong>{t('legal.hosting', 'Hébergement :')}</strong> Platform.sh / Railway.</p>
                                <p><strong>{t('legal.contact', 'Contact :')}</strong> contact@lawjustlaw.com | +33607517416</p>
                            </div>
                        </section>
                        ...
                        <section id="privacy">
                            ...
                            <div className="prose prose-green max-w-none text-gray-600 space-y-4">
                                <p>{t('legal.privacy_desc', "LawJustLaw s'engage à protéger vos données personnelles. Nous collectons uniquement les données nécessaires au bon fonctionnement de nos services juridiques.")}</p>
                        ...
                        <section id="terms">
                            ...
                            <div className="prose prose-orange max-w-none text-gray-600 space-y-4">
                                <p>{t('legal.terms_desc1', "L'utilisation de la plateforme LawJustLaw implique l'acceptation intégrale des présentes conditions d'utilisation.")}</p>
