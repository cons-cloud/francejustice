...
class AccountCreationTest(unittest.TestCase):
    def test_user_creation_logic(self):
        """
        Verify that user creation parameters are handled correctly for all roles.
        """
        roles_to_test = ["user", "lawyer", "admin", "student", "professor", "doctorate"]
        ...
        for role in roles_to_test:
            ...
            self.assertEqual(user_data["email"], f"{role}@example.com")
